...
#path = "Images/test/téléchargement (3).jpg"
path = "triof/camera/gobelet-plastique-couleur-20-cl-lot-de-25.png"

def first_prediction_azure(path):
    
    ENDPOINT = "https://projetp8.cognitiveservices.azure.com/"
